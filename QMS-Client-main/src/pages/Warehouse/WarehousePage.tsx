            ...
            <div className="flex flex-col md:flex-row gap-4 items-center w-full xl:w-auto">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex flex-col items-center justify-center w-24 h-20 bg-asvo-surface border border-asvo-border rounded-xl shadow-sm hover:shadow-md hover:border-asvo-accent transition group"
                    >
                        <div className="p-2 bg-asvo-accent-dim rounded-full group-hover:bg-asvo-accent-glow text-asvo-accent mb-1"><BarChart3 size={20}/></div>
                        <span className="text-[10px] font-bold text-asvo-text-mid uppercase">Аналитика</span>
                    </button>

                    <button
                        onClick={() => navigate(WAREHOUSE_INVENTORY_ROUTE)}
                        className="flex flex-col items-center justify-center w-24 h-20 bg-asvo-surface border border-asvo-border rounded-xl shadow-sm hover:shadow-md hover:border-asvo-orange transition group"
                    >
           ...
           {[
               ...
               <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 rounded-t-lg font-bold text-sm transition-all relative top-[1px] whitespace-nowrap ${
                      activeTab === tab.id
                      ? "bg-asvo-surface text-asvo-accent border border-asvo-border border-b-asvo-surface shadow-sm z-10"
                      : "text-asvo-text-mid hover:text-asvo-accent hover:bg-asvo-surface/50"
                  }`}
               >
                   {tab.icon} {tab.label}
               </button>
