    ...
    return (
        <div className="flex gap-4 overflow-x-auto pb-2 w-full md:w-auto">
            {topItems.map((item, idx) => (
                <div key={idx} className="bg-asvo-surface-2 border border-asvo-border p-3 rounded-xl shadow-sm flex flex-col gap-1 min-w-[200px]">
                    ...
                    <div className="w-full bg-asvo-surface-3 rounded-full h-1.5 overflow-hidden mt-1">
                        <div
