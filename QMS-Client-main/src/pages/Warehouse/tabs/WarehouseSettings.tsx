        ...
        <div className="animate-fade-in max-w-4xl mx-auto">
            <div className="flex justify-between items-end mb-6">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-9 pr-4 py-2 border border-asvo-border rounded-lg text-sm w-64 bg-asvo-surface-2 text-asvo-text focus:ring-2 focus:ring-asvo-accent/30 outline-none"
            ...
            <div className="bg-asvo-surface-2 rounded-xl shadow-sm border border-asvo-border overflow-hidden">
                <table className="w-full text-left">
                    <thead className="bg-asvo-surface text-xs text-asvo-text-mid uppercase font-semibold">
                        <tr>
                            ...
                            <tr key={idx} className="hover:bg-asvo-surface-3 transition">
                                ...
                                <td className="px-6 py-4 text-center">
                                    <input
                                        ...
                                        className="w-24 p-2 text-center border border-asvo-border rounded-lg bg-asvo-surface-2 text-asvo-text focus:border-asvo-accent focus:ring-2 focus:ring-asvo-accent/30 outline-none transition"
                                    />
                                </td>
