...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-asvo-surface border border-asvo-border rounded-xl shadow-2xl p-6 max-w-sm w-full mx-4">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="flex justify-center gap-4 mt-6 w-full">
            ...
            <button
              type="button"
              className="flex-1 bg-asvo-surface-3 text-asvo-text py-3 rounded-lg hover:bg-asvo-border transition font-semibold"
              onClick={handleCancel}
            >
              {cancelText}
            </button>
